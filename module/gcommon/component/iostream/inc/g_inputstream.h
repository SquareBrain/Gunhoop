...
public:
	...
	/**
	  ...
	  * This method should be overridden by subclasses.
        ...
        */
	virtual GInt32 available() {return 0;}
	...
	/**
        ...
        * @note 
        */
	virtual GInt32 read(GInt8* pBuffer, GInt32 iLen) = 0;
	...
	/**
	  ...
	  * This method should be overridden by subclasses.
        ...
        */
	virtual GInt32 read(GInt8* pBuffer, GInt32 iOffset, GInt32 iLen) = 0;
	...
	/**
        ...
        */
	virtual GInt32 skip(GInt32 iNum) = 0;
};
